...
function showNft() {
  ...
  const url = 'ethereum://0x4008de4e758bf2d066640ff8c469365782816af8/' + '8'
...
function buildClimbingArtwork(parkNumber: number, blockNumber: number, hash: string, smallConcept: boolean, puzzleMode: boolean, base64BlockNumberArray?: number[], movement?: boolean) {
  ...
  pathColors[7] = pathColors[5]
    ...
    engine.addEntity(buildPathWithColor3(2, 0.05, 16, 3, 0.025, 8, 0, pathColors[0], 'Oldest One-time Miner'))
...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(3, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
buildArtwork(12, 762, 'd898664323723661c037e39cd24e7290dee0ffe3aa1a62f3cb0ace3034814403')
