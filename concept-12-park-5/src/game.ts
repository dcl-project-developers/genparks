...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(5, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#A06080', 'DevCon-1: London'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#A040E0'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#A0A0C0'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#202080'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#E020E0'))
...
engine.addEntity(buildBench(15, 0, 8, 180, '#60E020'))



engine.addEntity(buildBench(8, 0, 1, 270, '#E02060'))
...
buildArtwork(12, 515000, '926287a535d7929ab81c0d72eb10f5711b8156d617f61d58b7b04ddab5673f78')
