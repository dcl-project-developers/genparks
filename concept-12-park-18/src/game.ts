...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(18, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#60E020', 'Decentraland MANA sale startBlock'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#806040'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#408020'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#80C020'))
...
engine.addEntity(buildBench(8, 0, 15, 90, '#404040'))
...
engine.addEntity(buildBench(8, 0, 1, 270, '#E06020'))
...
buildArtwork(12, 4170700, '6de40774564a3678218acc0f606c1e35464d632830db5c10e51e61f36e1326d3')
