...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#2040E0', 'DevCon-4: Prague'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#40E020')





  engine.addEntity(buildPath(13, 0, 8, 180, '#E04020')





  engine.addEntity(buildPath(8, 0, 3, 270, '#20E0E0')
...
engine.addEntity(buildBench(1, 0, 8, 0, '#E080C0'))



engine.addEntity(buildBench(8, 0, 15, 90, '#E02020'))



engine.addEntity(buildBench(15, 0, 8, 180, '#E06060'))



engine.addEntity(buildBench(8, 0, 1, 270, '#E02020'))
...
buildArtwork(2, 6610000, '1d47e931fc01f54f1119f5efd98ab4fd0e07ed6358da0d15de30611a7ecede69')
