...
function showNft() {
  ...
  const url = 'ethereum://0x4008de4e758bf2d066640ff8c469365782816af8/' + '23'
...
function buildClimbingArtwork(parkNumber: number, blockNumber: number, hash: string, smallConcept: boolean, puzzleMode: boolean, base64BlockNumberArray?: number[], movement?: boolean) {
  ...
  pathColors[7] = pathColors[5]
    ...
    engine.addEntity(buildPathWithColor3(2, 0.05, 16, 3, 0.025, 8, 0, pathColors[0], 'CryptoKitty #1 is born'))
...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(23, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
buildArtwork(12, 4605346, '62b5de48e43c2ff66623d272f9dd1db879870f9d78c840b450501b9e4fbe93ab')
