...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(10, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#4080E0', 'theDAO Fork'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#C04020'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#E0E040'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#60A0A0'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#6080E0'))



engine.addEntity(buildBench(8, 0, 15, 90, '#40C020'))



engine.addEntity(buildBench(15, 0, 8, 180, '#204060'))



engine.addEntity(buildBench(8, 0, 1, 270, '#40E020'))
...
buildArtwork(12, 1920000, '4985f5ca3d2afbec36529aa96f74de3cc10a2a4a6c44f2157a57d2c6059a11bb')
