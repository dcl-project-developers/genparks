...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(21, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#E0C0A0', 'DevCon-3: Cancun'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#E0E020'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#604080'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#204040'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#804020'))



engine.addEntity(buildBench(8, 0, 15, 90, '#40A0E0'))



engine.addEntity(buildBench(15, 0, 8, 180, '#20A040'))



engine.addEntity(buildBench(8, 0, 1, 270, '#606060'))
...
buildArtwork(12, 4470000, 'dcbe9efcdb05574f8f10323c794e2246add50a99445951695e3da78f4cb71ce7')
