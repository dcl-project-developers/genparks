...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(6, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#8040C0', 'One Million Blocks'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#E0E0C0'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#20C040'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#A0E080'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#E08080'))



engine.addEntity(buildBench(8, 0, 15, 90, '#E0A0A0'))



engine.addEntity(buildBench(15, 0, 8, 180, '#A020E0'))



engine.addEntity(buildBench(8, 0, 1, 270, '#E0A080'))
...
buildArtwork(12, 1000000, '8e38b4dbf6b11fcc3b9dee84fb7986e29ca0a02cecd8977c161ff7333329681e')
