...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(14, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#208080', 'Tangerine Whistle'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#A0E0C0'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#A02060'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#206060'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#202080'))



engine.addEntity(buildBench(8, 0, 15, 90, '#C0E060'))



engine.addEntity(buildBench(15, 0, 8, 180, '#204020'))



engine.addEntity(buildBench(8, 0, 1, 270, '#40A040'))
...
buildArtwork(12, 2463000, '2086799aeebeae135c246c65021c82b4e15a2c451340993aacfd2751886514f0')
