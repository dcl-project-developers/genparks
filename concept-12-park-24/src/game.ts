...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(24, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#20C060', 'The Birth of the DAI'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#A04080'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#A0A0E0'))
...
engine.addEntity(buildBench(8, 0, 15, 90, '#A0C060'))



engine.addEntity(buildBench(15, 0, 8, 180, '#E06020'))



engine.addEntity(buildBench(8, 0, 1, 270, '#8020C0'))
...
buildArtwork(12, 4752008, '1ccb5da1337a99a6f864046dbbc79ba3be50ff6122811eb3989f6a470d2492f1')
