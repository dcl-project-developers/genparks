...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(15, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#60E0E0', 'Spurious Dragon'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#2060E0'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#E0A040'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#E04040'))



engine.addEntity(buildBench(8, 0, 15, 90, '#2020A0'))



engine.addEntity(buildBench(15, 0, 8, 180, '#A0A0E0'))
...
buildArtwork(12, 2675000, '58eff9265aedf8a54da8121de1324e1e0d9aac99f694d16c6a41afffe3817d73')
