...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(12, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#C04080', 'DevCon-2: Shanghai'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#C0E080'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#E020C0'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#E0A0A0'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#202060'))



engine.addEntity(buildBench(8, 0, 15, 90, '#602060'))



engine.addEntity(buildBench(15, 0, 8, 180, '#2060A0'))



engine.addEntity(buildBench(8, 0, 1, 270, '#406020'))
...
buildArtwork(12, 2290000, 'b7307cb2eb75e101c7fa95972c255d6e03520a5390365b22cb07a8c7a3b849a2')
