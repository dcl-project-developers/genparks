...
function showNft() {
  ...
  // testing PARK NFT contract (see https://opensea.io/assets/0x4008de4e758bf2d066640ff8c469365782816af8/5)
...
function buildClimbingArtwork(parkNumber: number, blockNumber: number, hash: string, smallConcept: boolean, puzzleMode: boolean, base64BlockNumberArray?: number[], movement?: boolean) {
  ...
  pathColors[7] = pathColors[5]
    ...
    engine.addEntity(buildPathWithColor3(2, 0.05, 16, 3, 0.025, 8, 0, pathColors[0], 'The Terraform Event'))
...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(19, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
buildArtwork(12, 4321454, '0a989ad83a89295795f9cc128dd00be1e6b430a86137cce4bbf66c3f015fb0b7')
