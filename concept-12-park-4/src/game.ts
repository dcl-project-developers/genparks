...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(4, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#2080E0', 'The First ICO: Augur'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#A08020'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#40E080'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#202060'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#20C020'))



engine.addEntity(buildBench(8, 0, 15, 90, '#204020'))
...
engine.addEntity(buildBench(8, 0, 1, 270, '#E08040'))
...
buildArtwork(12, 88090, '0a7af5a5870648ff8c2c10691ac01e08451d054a15da8c4a843c5393752e2baa')
