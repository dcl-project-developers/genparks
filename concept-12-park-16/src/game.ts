...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(16, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#60A020', 'The Most Recent Pi Block'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#806080'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#C04020'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#604080'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#E060A0'))



engine.addEntity(buildBench(8, 0, 15, 90, '#402020'))



engine.addEntity(buildBench(15, 0, 8, 180, '#602040'))



engine.addEntity(buildBench(8, 0, 1, 270, '#40A020'))
...
buildArtwork(12, 3141592, '68a31d86567fcb4807643375ea68ab4d281a570d42399505c8e0b49ee574363f')
