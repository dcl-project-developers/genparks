...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(11, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#A060A0', 'EXTCODESIZE DoS Attack'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#60A0A0'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#80C080'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#A0E020'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#4020A0'))



engine.addEntity(buildBench(8, 0, 15, 90, '#A0C040'))
...
buildArtwork(12, 2283416, '9852a25198a980b28999db234404a99ebf38bd9531b330bf6d7cf4cfe0f904ea')
