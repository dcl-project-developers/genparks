...
function buildArtwork(conceptNumber: number, blockNumber: number, hash: string) {
  ...
  return buildClimbingArtwork(20, blockNumber, hash, true, true, base64BlockNumberArray, true)
}
...
function buildTree(x: number, y: number, z: number) {
  ...
  engine.addEntity(buildPath(3, 0, 8, 0, '#C0E0E0', 'Metropolis Byzantium'))





  engine.addEntity(buildPath(8, 0, 13, 90, '#604020'))





  engine.addEntity(buildPath(13, 0, 8, 180, '#E020A0'))





  engine.addEntity(buildPath(8, 0, 3, 270, '#6080C0'))
...
engine.addEntity(buildBench(1, 0, 8, 0, '#80E0C0'))



engine.addEntity(buildBench(8, 0, 15, 90, '#E060E0'))



engine.addEntity(buildBench(15, 0, 8, 180, '#C020A0'))



engine.addEntity(buildBench(8, 0, 1, 270, '#408020'))
...
buildArtwork(12, 4370000, 'b1fcff633029ee18ab6482b58ff8b6e95dd7c82a954c852157152a7a6d32785e')
